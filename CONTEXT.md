...
**Japan Release**:
An announced Japanese theatrical release or streaming start for a film on a calendar date, independently of whether a Tokyo Cinema currently publishes a Cinema Screening for it.
_Avoid_: Movie, Cinema Screening

**Release Calendar**:
The month-scoped list of Japan Releases, grouped by announced release date.
